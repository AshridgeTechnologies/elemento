...
test('shows allowed items in context insert menu of a page item', async () => {
    ...
    expect(optionsShown()).toStrictEqual(['Text', 'Text Input', 'Number Input','Select Input', 'True False Input', 'Date Input', 'Speech Input', 'Button', 'Form', 'Image', 'Icon', 'User Logon', 'Menu', 'List', 'Item Set', 'Data', 'Calculation', 'Timer', 'Function', 'Function Import', 'Collection', 'Layout', 'Block'])
})
