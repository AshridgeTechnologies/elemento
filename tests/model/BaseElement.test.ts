...
test('keeps notes when updating another property', () => {
    const text1 = newText('text_1', 'Text 1', {content: ex`"Some text"`, notes: 'Some notes'})
...
test('assigns new ids to a tree of elements', () => {
    ...
    let expectedApp
    {
        const text1 = newText('text_8', 'Text 1', {content: ex`"Some text"`})
        const text2 = newText('text_9', 'Text 2', {content: ex`"Some text"`})
        const page1 = new Page('page_3', 'Page 1', {}, [text1, text2])
        const text3 = newText('text_10', 'Text 3', {content: ex`"Some text 3"`})
        const text4 = newText('text_11', 'Text 4', {content: ex`"Some text 4"`})
...
describe('doInsert function', () => {
    const inserted = newText('text_5', 'Text 5', {content: 'Hi!'})
