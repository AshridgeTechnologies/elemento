...
test('Function has correct properties with specified values', ()=> {
    const function1 = new FunctionDef('id1', 'Function 1', {input1: 'in1', input2: 'in2', input3: 'in3', input4: 'in4', input5: 'in5', calculation: ex`doIt()`})
...
test('converts to JSON with optional properties', ()=> {
    const functionDef = new FunctionDef('id1', 'Function 1', {input1: 'in1', input2: 'in2', input3: 'in3', input4: 'in4', input5: 'in5', calculation: ex`doIt()`})
    expect(asJSON(functionDef)).toStrictEqual({
        kind: 'Function',
        id: 'id1',
        name: 'Function 1',
