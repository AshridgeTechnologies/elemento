...
const text1 = createElement(TextElement, {path: 'app.bar1.text1', styles: {width: 200}}, 'First text')
const text2 = createElement(TextElement, {path: 'app.bar1.text2', styles: {width: 200}}, 'Second text')
