...
export default () =>
    <Section id='projects-overview'>
        ...
        <Para>Elemento stores the information about a Project in a set of files in a folder on your computer disk.  
            You can copy this folder for backup, to share it with someone or to start another similar Project.</Para>
        <Para>When you are ready,the folder can also be copied into a code storage (or source control) system on the internet.  
            Elemento includes tools to work with the widely-used GitHub system, but you can use others if you use their tools outside Elemento.</Para>
        ...
        <BulletList>
            ...
            <li>It is the simplest way of publishing your App for others to use.
                Elemento provides a means for anyone to run an App directly from GitHub</li>            
        ...
        <Para>At the top-level of a Project, there can be several types of element.
            Most simple Projects will have one App and possibly some Files for images.  More advanced projects may use multiple Apps, together with Server Apps,
        ...
        <NamedList>
            ...
            <NLItem name='Data Type'>The <HelpLink id='dataType'>Data Type</HelpLink>s represent definitions of some data specific the Project, such as a Customer record.
                They are created in the Data Types area under the Project.
            </NLItem>
            <NLItem name='Server App'>A <HelpLink id='serverApp'>Server App</HelpLink>s is a type of app, used in more advanced Projects, that runs in a server in the cloud, not in the browser.
            </NLItem>
            <NLItem name='Tool'>A <HelpLink id='tool'>Tool</HelpLink>s is a special type of app, that is used to help you while <em>developing</em> the Project
