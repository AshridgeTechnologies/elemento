...
export default () =>
    <Section id='apps-overview'>
        ...
        <Para>Most <HelpLink id='projects-overview'>Projects</HelpLink> will just contain one App, but some advanced systems may have more than one.</Para>
        ...
        <Para>An App Bar is a fixed component displayed above every Page in the App.
        ...
        <NamedList>
            ...
            <NLItem name='Functions'>A <HelpLink id='function'>Function</HelpLink> under an App can be used in any Page.
                If you need to do the same thing in several Pages, consider creating a Function under the App rather than copying the formula in each Page.
            </NLItem>
