...
export default () =>
    <Section id='function-reference'>
        ...
        <FunctionSection name='Range' id='Range' resultType='list of number'
                         description='Create a list of numbers between a given start and end value.  If start is greater than end the numbers are in descending order'
                         ...
                         inputs={<>
                             ...
                             <FunctionInput name='Step' type='number' optional>The gap between each number, 1 is used if not given.</FunctionInput>
                         </>
                         }
                         examples={<>
