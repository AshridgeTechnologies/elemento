...
export default () =>
    <Section id='function-reference'>
        ...
        <FunctionSection name='Add' id='Add' resultType='number or Decimal'
                         description='Add together two or more numbers.  If any of the numbers is a Decimal, the result will be a Decimal'

                         inputs={<>
                <FunctionInput name='First Number' type='number or Decimal'>The first number to add.</FunctionInput>
                <FunctionInput name='Second Number' type='number or Decimal'>The second number to add.</FunctionInput>
                <FunctionInput name='Number 3, 4, 5, etc...' type='number or Decimal' optional>Further numbers to add</FunctionInput>
            </>
            }
                         examples={<>
                <FunctionExample name='Add' inputs={['10', '20', '30']}>Result: 60</FunctionExample>
                <FunctionExample name='Add' inputs={['D(10)', '20', '30']}>Result: Decimal with a value of 60.0</FunctionExample>
            </>}
        />
        ...
        <FunctionSection name='And' id='And' resultType='true-false'
                         ...
                         inputs={<>
                             <FunctionInput name='First value' type='true-false'>The first value to check</FunctionInput>
                             <FunctionInput name='Second value' type='true-false'>The second value to check</FunctionInput>
                             <FunctionInput name='Further values...' type='true-false' optional>Any further values to check</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='And' inputs={['true', 'false']}>Result: false</FunctionExample>
                             <FunctionExample name='And' inputs={['true', 'false', 'true', 'true']}>Result: false</FunctionExample>
                             <FunctionExample name='And' inputs={['true', 'true']}>Result: true</FunctionExample>
                             <FunctionExample name='And' inputs={['Gt(Length, 1)', 'Type == "Medium"']}>Result: true if Length is greater than 1 and Type is "Medium"</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Ceiling' id='Ceiling' resultType='number'
                         ...
                         inputs={<>
                             ...
                             <FunctionInput name='Decimal Digits' type='number' optional>The number of decimal digits to round up to. If not given, assumes no decimal digits.</FunctionInput>
                         </>
                         }
                         examples={<>
        ...
        <FunctionSection name='CsvToRecords' id='CsvToRecords' resultType='list of records'
                         ...
                         inputs={<>
                             <FunctionInput name='CSV Data' type='text'>The text containing the CSV rows.</FunctionInput>
                             <FunctionInput name='Column Names' type='list of text' optional>The names of the columns. If not given, assumes the names are in the first row.</FunctionInput>
                         </>
                         }
                         examples={<>
        ...
        <FunctionSection name='D' id='D' resultType='decimal'
                ...
                <FunctionInput name='Number' type='text or number'>The number to be converted.
                         ...
                         examples={<>
                <FunctionExample name='D' inputs={['10']}>This results in a Decimal with the value 10.0</FunctionExample>
                <FunctionExample name='D' inputs={['"27.3456"']}>This results in a Decimal with the value 27.3456</FunctionExample>
            </>}
        />
        ...
        <FunctionSection name='DateAdd' id='DateAdd' resultType='date'
                ...
                <FunctionInput name='Change' type='number'>The number of Units to add (or subtract if negative)</FunctionInput>
                <FunctionInput name='Unit' type='text'>The units to get the difference in.
                    One of: "seconds", "minutes", "hours", "days", "months", "years"</FunctionInput>
                         ...
                         examples={<>
                <FunctionExample name='DateAdd' inputs={['DateVal("2022-03-01")', '10', '"day"']}>Result: 11 March 2022</FunctionExample>
                <FunctionExample name='DateAdd' inputs={['DateVal("2019-03-01")', '4', '"year"']}>Result: 1 March 2023</FunctionExample>
                <FunctionExample name='DateAdd' inputs={['DateVal("2022-03-01T02:03:25")', '-10', '"seconds"']}>Result: 1 March 2022 at 02:03 and 15 seconds</FunctionExample>
            </>}
        />
        ...
        <FunctionSection name='DateFormat' id='DateFormat' resultType='text'
                ...
                <FunctionInput name='Format' type='text'>The format in which to represent the date.
                    The format is a set of letter codes following <Link href='https://date-fns.org/v2.30.0/docs/parse'>these rules</Link></FunctionInput>
            </>
            }
                         examples={<>
                <FunctionExample name='DateFormat' inputs={['DateVal("2022-03-01")', '"dd MMM yyyy"']}>Result: "01 Mar 2022"</FunctionExample>
                <FunctionExample name='DateFormat' inputs={['DateVal("2022-03-01T02:03:25")', '"dd/MM/yy HH:mm"']}>Result: "01/03/22 02:03"</FunctionExample>
            </>}
        />
        ...
        <FunctionSection name='DateVal' id='DateVal' resultType='date'
            ...
            <Para>Create a Date from various other values.</Para>
                             <dl>
                                 <dt>Single text value</dt>
                                 <dd>The text is interpreted as a standard <Link href='https://www.iso.org/iso-8601-date-and-time-format.html'>ISO date</Link>.
                                     So "2022-03-04 12:34:56" would result in a date of 4 April 2022 at 12:34 and 56 seconds</dd>

                                 <dt>Year, month and day as numbers</dt>
                                 <dd>Gives a date with the given year, month, day</dd>

                                 <dt>Text date, format (advanced usage)</dt>
                                 <dd>Interprets the text according to the format.
                                     The format is a set of letter codes following <Link href='https://date-fns.org/v2.30.0/docs/parse'>these rules</Link>
                                 </dd>
                                 <dt>A date value</dt>
                                 <dd>The result is the same date value</dd>

                                 <dt>A null (empty) value</dt>
                                 <dd>The result is null</dd>
                             </dl>
                         </>
        }
                         ...
                         examples={<>
                             <FunctionExample name='DateVal' inputs={['"2022-03-01"']}>Result: 1 March 2022 at midnight</FunctionExample>
                             <FunctionExample name='DateVal' inputs={['"2022-03-01T02:03:14"']}>Result: 1 March 2022 at 02:03 and 14 seconds</FunctionExample>
                             <FunctionExample name='DateVal' inputs={['2022', '3', '1']}>Result: 1 March 2022 at midnight</FunctionExample>
                             <FunctionExample name='DateVal' inputs={['"01 Mar 2022', '"dd MMM yyyy"']}>Result: 1 March 2022 at midnight</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='DaysBetween' id='DaysBetween' resultType='number'
                         ...
                         inputs={<>
                             <FunctionInput name='First Date' type='date'>The date expected to be earlier</FunctionInput>
                             <FunctionInput name='Second Date' type='date'>The date expected to be later</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='DaysBetween' inputs={['DateVal("2022-03-01")', 'DateVal("2022-03-21")']}>Result: 20</FunctionExample>
                             <FunctionExample name='DaysBetween' inputs={['DateVal("2022-03-01T02:03:00")', 'DateVal("2022-03-01T12:04:00")']}>Result: 0</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Div' id='Div' resultType='number or Decimal'
                         ...
                         inputs={<>
                             <FunctionInput name='First Number' type='number or Decimal'>The number to start with.</FunctionInput>
                             <FunctionInput name='Second Number' type='number or Decimal'>The first number to divide First Number by.</FunctionInput>
                             <FunctionInput name='Number 3, 4, 5, etc...' type='number or Decimal' optional>Further numbers to divide by</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Div' inputs={['60', '10']}>Result: 6 (60 / 10)</FunctionExample>
                             <FunctionExample name='Div' inputs={['D(10)', '20', '50']}>Result: Decimal with a value of 0.01 (10 / 20 / 50)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Eq' id='Eq' resultType='true-false'
                         ...
                         inputs={<>
                             <FunctionInput name='First Number' type='number or Decimal'>The first number to compare</FunctionInput>
                             <FunctionInput name='Second Number' type='number or Decimal'>The second number to compare</FunctionInput>
                         </>
                         }
                         examples={<>
        ...
        <FunctionSection name='First' id='First' resultType='any'
                         ...
                         inputs={<>
                             <FunctionInput name='Values' type='list of any type'>The list of values to select from</FunctionInput>
                             <FunctionInput name='Condition' type='formula giving true-false'>Used to check the values to find the result.
                                 It is applied to each of Values in turn, and if it results in true, that value is the result.
                                 It should use the special name <code>$item</code> to mean the item that is being checked.
                             </FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='First' inputs={['List(10, 20, 30, 40)', 'Gt($item, 25)']}>Result: 30</FunctionExample>
                             <FunctionExample name='First' inputs={['List("Ahmed", "Bobo", "Candice", "Jo")', 'Gt($item.length, 5)']}>Result: "Candice"</FunctionExample>
                             <FunctionExample name='First' inputs={['List(50, 10, 20, 30, 40)', 'Gt($item, 100)']}>Result: empty (null)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Floor' id='Floor' resultType='number'
                         ...
                         inputs={<>
                             ...
                             <FunctionInput name='Decimal Digits' type='number' optional>The number of decimal digits to round down to. If not given, assumes no decimal digits.</FunctionInput>
                         </>
                         }
                         examples={<>
        ...
        <FunctionSection name='ForEach' id='ForEach' resultType='list of any type'
                         ...
                         inputs={<>
                             <FunctionInput name='Values' type='list of any type'>The starting list of values</FunctionInput>
                             <FunctionInput name='Formula' type='formula giving any type'>Calculates each of the values in the result.
                                 It is applied to each of Values in turn, and its result is added to the result list.
                                 It should use the special name <code>$item</code> to mean the item in the original list that it is being applied to.
                             </FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='ForEach' inputs={['List(50, 10, 20)', '$item + 2)']}>Result: list containing 52, 12, 22</FunctionExample>
                             <FunctionExample name='ForEach' inputs={['List("Andrew", "Bobo", "Candice", "Jo")', '$item.length']}>Result: list containing 6, 4, 7, 2</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Gt' id='Gt' resultType='true-false'
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Gt' inputs={['D(10)', '10']}>Result: false, because the first number is equal to the second, not greater</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='If' id='If' resultType='any'
                         ...
                         inputs={<>
                             <FunctionInput name='Condition' type='true-false'>Controls which of the two values is used in the result</FunctionInput>
                             <FunctionInput name='Value 1' type='any'>The result if Condition is true</FunctionInput>
                             <FunctionInput name='Value 2' type='any' optional>The result if Condition is false.  If this input is not supplied,
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='If' inputs={['Lt(10, 9)', '20']}>Result: empty (undefined)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Last' id='Last' resultType='any'
                         ...
                         inputs={<>
                             <FunctionInput name='Values' type='list of any type'>The list of values to select from</FunctionInput>
                             <FunctionInput name='Condition' type='formula giving true-false'>Used to check the values to find the result.
                                 It is applied to each of Values in turn, working back from the end and if it results in true, that value is the result.
                                 It should use the special name <code>$item</code> to mean the item that is being checked.
                             </FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Last' inputs={['List(10, 20, 30, 40)', 'Gt($item, 25)']}>Result: 40</FunctionExample>
                             <FunctionExample name='Last' inputs={['List("Ahmed", "Bobo", "Candice", "Jo")', 'Gt($item.length, 4)']}>Result: "Candice"</FunctionExample>
        ...
        <FunctionSection name='Left' id='Left' resultType='text'
                         ...
                         inputs={<>
                             ...
                             <FunctionInput name='Length' type='number'>The number of characters to take from the start of Text.  
                                 If this is more than the length of Text, the result is the whole of Text.</FunctionInput>
                         </>
                         }
                         examples={<>
                             ...
                             <FunctionExample name='Left' inputs={['"abcde"', '0']}>Result: "" (an empty text)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Log' id='Log' resultType='action'
                ...
                <FunctionExample name='Log' inputs={['"The delivery amount is"', 'Delivery']}>If Delivery had the value 20, this would log: The delivery amount is 20</FunctionExample>
            </>}
        />
        ...
        <FunctionSection name='Lt' id='Lt' resultType='true-false'
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Lt' inputs={['D(10)', '10']}>Result: false, because the first number is equal to the second, not less</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Max' id='Max' resultType='number or Decimal'
                         ...
                         inputs={<>
                             <FunctionInput name='First Number' type='number or Decimal'>The first number to compare.</FunctionInput>
                             <FunctionInput name='Second Number' type='number or Decimal'>The second number to compare.</FunctionInput>
                             <FunctionInput name='Number 3, 4, 5, etc...' type='number or Decimal' optional>Further numbers to compare</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Max' inputs={['10', '20', '30']}>Result: 30</FunctionExample>
                             <FunctionExample name='Max' inputs={['D(10)', '50', '30']}>Result: Decimal with a value of 50.0</FunctionExample>
                             <FunctionExample name='Max' inputs={['D(-10)', '-50', '-30']}>Result: Decimal with a value of -10.0, because -10 is greater than -30 or -50</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Mid' id='Mid' resultType='text'
                         ...
                         inputs={<>
                             <FunctionInput name='Text' type='text'>The original text</FunctionInput>
                             <FunctionInput name='Start' type='number'>The character position in Text at which the result starts.
                                 If this is more than the length of Text, the result is an empty Text.</FunctionInput>
                             <FunctionInput name='Length' type='number' optional>The number of characters to take from the start of Text.
                                 If this plus Start is more than the length of Text, the result is the whole of Text from Start.
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Mid' inputs={['"abcde"', '6']}>Result: "" (an empty text)</FunctionExample>
        ...
        <FunctionSection name='Min' id='Min' resultType='number or Decimal'
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Min' inputs={['10', 'D(50)', '30']}>Result: Decimal with a value of 10.0</FunctionExample>
                             <FunctionExample name='Min' inputs={['D(-10)', '-50', '-30']}>Result: Decimal with a value of -50.0, because -50 is less than -30 or -10</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Mult' id='Mult' resultType='number or Decimal'
                         ...
                         inputs={<>
                             <FunctionInput name='First Number' type='number or Decimal'>The first number to multiply.</FunctionInput>
                             <FunctionInput name='Second Number' type='number or Decimal'>The second number to multiply.</FunctionInput>
                             <FunctionInput name='Number 3, 4, 5, etc...' type='number or Decimal' optional>Further numbers to multiply</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Mult' inputs={['5', '10']}>Result: 50 (5 x 10)</FunctionExample>
                             <FunctionExample name='Mult' inputs={['D(10)', '20', '30']}>Result: Decimal with a value of 6000.0</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Not' id='Not' resultType='true-false'
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Not' inputs={['Gt(Length, 1)']}>Result: false if Length is greater than 1 </FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Now' id='Now' resultType='Date'
                         ...
                         examples={<>
                             <FunctionExample name='Now' inputs={[]}>Result: 2022-03-04 16:34:56 (the result is different every time)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Or' id='Or' resultType='true-false'
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Or' inputs={['false', 'false', 'true', 'false']}>Result: true</FunctionExample>
                             <FunctionExample name='Or' inputs={['false', 'false']}>Result: false</FunctionExample>
                             <FunctionExample name='Or' inputs={['Gt(Length, 1)', 'Type == "Medium"']}>Result: true if Length is greater than 1 <b>or</b> Type is "Medium"</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Random' id='Random' resultType='date'
                         description={<>
                             ...
                             <dl>
                                 <dt>No inputs</dt>
                                 <dd>A fractional random number between 0 and 1 (never actually 1)</dd>

                                 <dt>Single number</dt>
                                 <dd>A random whole number between 0 and the number given (including 0 and the number given)</dd>

                                 <dt>Multiple values</dt>
                                 <dd>One of the values, chosen at random</dd>
                                 
                                 <dt>A single List of values</dt>
                                 <dd>One of the values in the list, chosen at random</dd>
                             </dl>
                         </>
                         }
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Random' inputs={['10', '20', '30']}>Random choice from 10, 20 or 30</FunctionExample>
                             <FunctionExample name='Random' inputs={['true', 'false']}>Random choice of true or false</FunctionExample>
                             <FunctionExample name='Random' inputs={['List("Red", "Green", "Blue")']}>Random choice from "Red", "Green" or "Blue"</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Right' id='Right' resultType='text'
                         ...
                         inputs={<>
                             <FunctionInput name='Text' type='text'>The original text</FunctionInput>
                             <FunctionInput name='Length' type='number'>The number of characters to take from the end of Text.
                         ...
                         examples={<>
                             ...
                             <FunctionExample name='Right' inputs={['"abcde"', '6']}>Result: "abcde" (an empty text)</FunctionExample>
                             <FunctionExample name='Right' inputs={['"abcde"', '0']}>Result: "" (an empty text)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Round' id='Round' resultType='number'
                         ...
                         inputs={<>
                             ...
                             <FunctionInput name='Decimal Digits' type='number' optional>The number of decimal digits to round to. If not given, assumes no decimal digits.</FunctionInput>
                         </>
                         }
                         examples={<>
        ...
        <FunctionSection name='Select' id='Select' resultType='list of any type'
                         ...
                         inputs={<>
                             <FunctionInput name='Values' type='list of any type'>The list of values to select from</FunctionInput>
                             <FunctionInput name='Condition' type='formula giving true-false'>Controls which of the values are included in the result.
                                 It is applied to each of Values in turn, and if it results in true, that value is included.
                             It should use the special name <code>$item</code> to mean the item that is being checked.
                             </FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Select' inputs={['List(50, 10, 20, 30, 40)', 'Gt($item, 25)']}>Result: list containing 50, 30, 40</FunctionExample>
                             <FunctionExample name='Select' inputs={['List("Andrew", "Bobo", "Candice", "Jo")', 'Gt($item.length, 5)']}>Result: list containing "Andrew", "Candice"</FunctionExample>
                             <FunctionExample name='Select' inputs={['List(50, 10, 20, 30, 40)', 'Gt($item, 100)']}>Result: empty list</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Set' id='Set' resultType='action'
                         ...
                         inputs={<>
                <FunctionInput name='Element' type='Data Element'>The Data element in which the value is set.</FunctionInput>
        ...
        <FunctionSection name='Sort' id='Sort' resultType='list of any type'
                         ...
                         inputs={<>
                             <FunctionInput name='Values' type='list of any type'>The starting list of values</FunctionInput>
                             <FunctionInput name='Formula' type='formula giving any type'>Calculates the sort value for each of the values in the result.
                         ...
                         examples={<>
                             <FunctionExample name='Sort' inputs={['List(50, 10, 20)', '$item)']}>Result: list containing 10, 20, 50</FunctionExample>
                             <FunctionExample name='Sort' inputs={['List(50, 10, 20)', '0 - $item)']}>Result: list containing 50, 20, 10</FunctionExample>
                             <FunctionExample name='Sort' inputs={['List("Andrew", "Bobo", "Candice", "Jo")', '$item.length']}>Result: list containing "Jo", "Bobo", "Andrew", "Candice"</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Sub' id='Sub' resultType='number or Decimal'
                         ...
                         inputs={<>
                             <FunctionInput name='First Number' type='number or Decimal'>The number the others are subtracted from.</FunctionInput>
                             <FunctionInput name='Second Number' type='number or Decimal'>The first number to subtract.</FunctionInput>
                             <FunctionInput name='Number 3, 4, 5, etc...' type='number or Decimal' optional>Further numbers to subtract</FunctionInput>
                         </>
                         }
                         examples={<>
                             <FunctionExample name='Sub' inputs={['60', '10']}>Result: 50 (60 - 10)</FunctionExample>
                             <FunctionExample name='Sub' inputs={['D(10)', '20', '30']}>Result: Decimal with a value of -40.0 (10 - 20 - 30)</FunctionExample>
                         </>}
        />

        <FunctionSection name='Sum' id='Sum' resultType='number'
                         description='An alternative name for Add'
        ...
        <FunctionSection name='TimeBetween' id='TimeBetween' resultType='number'
                         ...
                         examples={<>
                             <FunctionExample name='TimeBetween' inputs={['DateVal("2022-03-01")', 'DateVal("2022-07-01")', "months"]}>Result: 4</FunctionExample>
                             <FunctionExample name='TimeBetween' inputs={['DateVal("2022-03-01T02:03:00")', 'DateVal("2022-03-01T02:04:00")', "seconds"]}>Result: 60</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Timestamp' id='Timestamp' resultType='number'
                         ...
                         examples={<>
                             <FunctionExample name='Timestamp' inputs={[]}>Result: 1695037211726 (the result is different every time)</FunctionExample>
                         </>}
        />
        ...
        <FunctionSection name='Today' id='Today' resultType='Date'
                         ...
                         examples={<>
                             <FunctionExample name='Today' inputs={[]}>Result: 2022-03-04 100:00:00 (the result is different every time)</FunctionExample>
                         </>}
        />

        <FunctionSection name='Update' id='Update' resultType='action'
                ...
                <FunctionExample name='Update' inputs={['Customer', '{Firstname: "Marcel", Surname: "Dupont"}']}>
                                 This will update the Firstname and Surname data items in the Customer Data element, but leave all the other data items the same.
                </FunctionExample>
            </>}
        />
